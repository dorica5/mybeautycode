...
/** Same stroke as plus — light / regular, not bold. */
const ROW_STROKE = 1.5 as const;
...
/** Clock outline — same stroke weight and caps as {@link AddClientRowIcon}. */
export function PendingClockRowIcon({ size = 24, color = "#212427" }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Circle
        cx={12}
